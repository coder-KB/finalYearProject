                ...
                <div className="row" key={i}>
                    ...
                    <div className="col-2 FormGroup m-0">
                        <select
                            ...
                            value={section.subjects[i].teacherName}
                    ...
                    <div className="col-2 FormGroup m-0">
                        <input
                            type="number"
                            value={section.subjects[i].credits}
                    ...
                    <div className="col-2 FormGroup m-0">
                        <input
                            type="number"
                            value={section.subjects[i].startSlot}
    ...
    return (
        <Home>
            <div className="container bg-info p-4 m-5">
                <h2 className="text-center text-success">Add a new section</h2>
